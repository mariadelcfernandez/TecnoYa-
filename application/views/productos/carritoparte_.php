			...
			<div class="col"> 
				<div class="row">
					<div class="col-md-12" id="carrito"> 		
						<div class="cart" >
							<div class = "heading">
							    <h2 class="tit text-center" id="h2" style-align="center">Productos en tu Carrito</h2>
							</div>
							<div class="text ml-2" style-align="center"> 
								...
								if (empty($cart_check)) 
								{
									echo 'Ver productos, click aquí';
									echo 'Ver planes alimentarios, click aquí';
								} ?> 
								...
								if ($cart = $this->cart->contents()): 
								    ...
								    <tr class="table-light">
								        ...
								        <td class="text-right">
					                		...
					                		<input type="button" class ='btn btn-dark fuenteBotones btn-md' value="Borrar Carrito" onclick="window.location = 'borrar_carri' "> 
							        	</td>
									    <td class="text-center">
									       	<!-- Submit boton. Actualiza los datos en el carrito -->
						                	<input type="submit" class ='btn btn-dark fuenteBotones btn-md' value="Actualizar">
						                </td>
							            <td class="text-left">
									        <!-- " Confirmar orden envia a carrito_controller/muestra_compra  -->
									        <input type="button" class ='btn btn-dark fuenteBotones btn-md' value="Confirmar Orden" onclick="window.location = 'confirma_compra' ">
									    </td>
									    <td> </td>
								    </tr>
